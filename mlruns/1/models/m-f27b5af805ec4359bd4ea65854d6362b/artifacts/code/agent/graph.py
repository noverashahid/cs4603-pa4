...
def load_mcp_tools(server_path: str | None = None):
    ...
    if needs_swap:
        ...
        devnull_stream = os.fdopen(devnull_fd, "w")
        sys.stderr = devnull_stream

    try:
        # Must import here, AFTER the swap above — this is what triggers
        # mcp.client.stdio's first import and bakes in its errlog default.
        from langchain_mcp_adapters.client import MultiServerMCPClient
